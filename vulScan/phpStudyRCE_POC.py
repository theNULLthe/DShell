...
==================================================
    ...
    def output(self):
        ...
        if not os.path.isdir(r"../output/vulScan/phpstudyRCE"):
            os.mkdir(r"../output/vulScan/phpstudyRCE")
        self.outputFile = f"../output//vulScan/phpstudyRCE/{self.args.output}.txt"
