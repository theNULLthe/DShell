...
==================================================
    ...
    def output(self):
        ...
        if not os.path.isdir(r"../output/vulScan/ShowDocUAF"):
            os.mkdir(r"../output/vulScan/ShowDocUAF")
        self.outputFile = f"../output//vulScan/ShowDocUAF/{self.pocName}_{self.args.output}.txt"
