...
class ApacheSolrReadAnyFile:
    ...
    def output(self):
        ...
        if not os.path.isdir(r"../output/vulScan/ApacheSolrRAF"):
            os.mkdir(r"../output/vulScan/ApacheSolrRAF")
        self.outputFile = f"../output/vulScan/ApacheSolrRAF/{self.args.output}.txt"
